...
```
```{r, echo = FALSE}
picture2 <- load.image('/Users/CKA/Desktop/Master 2021 Fall/ST558 data science for statistician/pikachu.png')
...
Anyway, doing this is a lot of fun. And there are  some places definitely need to be polished, such as coding part.  
